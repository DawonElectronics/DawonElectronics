CREATE VIEW dbo.view_uv_workorder AS
...
tuw.txid,tu_in.user_name as trackin_username,tuw.trackin_time,tu_out.user_name as trackout_username,tuw.trackout_time,tuw.lot_type,tuw.WaitTrackout,
...
from (select * FROM tb_uv_workorder wo WHERE wo.isDone = 0) tuw 
